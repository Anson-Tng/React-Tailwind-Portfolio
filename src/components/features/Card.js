...
const Card = ({title,desc,icon}) => {
  return (
    ...
    <div className='h-72 py-10 overflow-y-hidden'>
        <div className='flex h-full flex-col gap-8 translate-y-20 group-hover:translate-y-0 transition-transform duration-500'>
